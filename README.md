...
or name a specific one: `/buildpartner:build self-improving-system`.
...
A friendly reminder to run `/buildpartner:improve-system` fires on Mondays and Fridays at session start.
